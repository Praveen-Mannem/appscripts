 ...
 * 2. Have not logged in for the last 180 days OR have never logged in.
 * 
 * Output:
...
const CONFIG = {
    ...
    INACTIVITY_DAYS: 180,  // Changed from 365 to 180 days
        ...
        <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
          <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
            <h2 style="color: #4285f4; border-bottom: 2px solid #4285f4; padding-bottom: 10px;">
              📊 Inactive Users Audit Report (180 Days)
            </h2>
